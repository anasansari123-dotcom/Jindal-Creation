  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Pehle category banayein, phir product name aur product number add karein.
          </p>
        </div>
      ...
      <div className="flex items-center gap-2 rounded-lg bg-gold/10 border border-gold/30 px-4 py-3 text-sm text-navy">
        ...
        <span>
          <strong>Format:</strong> Category → Product Name → Number. Same naam ya same number dono
          alag products me use ho sakte hain — category + number se pehchan karein.
        </span>
      </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Same naam se multiple products bana sakte hain
                  </p>
                </div>
                <div>
